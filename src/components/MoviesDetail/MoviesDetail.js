                ...
                <div className="container">
                    <div className="movieInfo">
                        ...
                        <p className="statistical">
                            ...
                            <span className="popularity">Popularlity : {movie && movie.popularity}</span>
                        </p>
...
const MoviesDetailModal = styled.div`
    .backdrop {
        ...
        animation: ${fadeIn} 1s cubic-bezier(.17, .85, .45, 1) forwards;
    }
    ...
    .modal {
        ...
        box-shadow: 0 15px 40px rgba(var(--color-dark), .2);
